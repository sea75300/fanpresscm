...
<div class="<?php \fpcm\view\helper::buttonsContainerClass(); ?> fpcm-ui-list-buttons fpcm-filemanager-buttons <?php if ($mode > 1) : ?>fpcm-hidden fpcm-buttons-fixed-full<?php endif; ?>">
