...
$lang = array (
  ...
  'ARTICLE_SEARCH_CHGUSER' => 'Latest change by user',
  'ARTICLE_SEARCH_COMMENTS' => 'Comments active',
  'ARTICLE_SEARCH_DATE_FROM' => 'Create date from',
  'ARTICLE_SEARCH_DATE_FROM_CHG' => 'Change date from',
  'ARTICLE_SEARCH_DATE_TO' => 'Create date until',
  'ARTICLE_SEARCH_DATE_TO_CHG' => 'Change date until',
  ...
  'COMMMENT_MOVE' => 'Comment is assign to article',
  ...
  'CRONJOB_REMINDERMAILS' => 'Submit reminders to offline users',
  ...
  'FILE_FORM_UPLOADPAUSE' => 'Pause upload',
  'FILE_FORM_UPLOADRESUME' => 'Resume upload',
  ...
  'FILE_LIST_EDIT_DYNAMIC' => 'Move selection and image (not) at once',
  'FILE_LIST_EDIT_FLIP' => 'Flip image',
  ...
  'FILE_LIST_INSERT_FAILED_IMAGE' => 'The selected file cannot be inserted as an image.',
  'FILE_LIST_INSERT_FAILED_VIDEO' => 'The selected file cannot be inserted as a video.',
  ...
  'GLOBAL_SHOW' => 'Show',
  'GLOBAL_SORT_BY' => 'Order by',
  'GLOBAL_SORT_ODER' => 'Order is',
  ...
  'HELP_TOP_MENU_FUNCTIONS' => 'Function in top menu',
  'HL_ARCHIVE' => 'Archive',
  ...
  'HL_PACKAGEMGR_SYSUPDATES' => 'Install system update',
  'HL_PROFILE' => 'Profile',
  'HL_REMINDER' => 'Reminders',
  ...
  'INTEGRATION_INCLUDE_API' => 'Include API class',
  'INTEGRATION_INCLUDE_CSS' => 'CSS styles',
  'INTEGRATION_LATEST_NEWS' => 'Show latest news',
  'INTEGRATION_PAGE_NUMBERS_TITLE' => 'Include page numbers in site title',
  'INTEGRATION_RSS_FEED' => 'Include RSS Feed',
  'INTEGRATION_SHOW_ARTICLES' => 'Show articles',
  'INTEGRATION_SHOW_ARTICLE_TITLE' => 'Include article headline in page title',
  'INTEGRATION_TEXT_API' => 'Insert the following code snippet into the file: %s',
  'INTEGRATION_TEXT_API_MAINFILE' => 'Insert the path to your the file, your site is usually entered.',
  'INTEGRATION_TEXT_ARTICLE_TITLE' => 'Insert the following code snippet into the "title" into your website.',
  'INTEGRATION_TEXT_CSS' => 'Insert the following code snippet into your CSS file, which is used by your website.',
  'INTEGRATION_TEXT_LATEST_NEWS' => 'Insert the following code snippet at the position, where "Latest News" should be displayed.',
  'INTEGRATION_TEXT_PAGE_TITLE' => 'Insert the following code snippet into the "title" into your website.',
  'INTEGRATION_TEXT_RSS_FEED' => 'Insert the following code snippet into the "head" into your website.',
  'INTEGRATION_TEXT_SHOW_ARTICLE' => 'Insert the following code snippet at the position, where articles and your website content is displayed.',
  'INTEGRATION_TEXT_SHOW_ARTICLE_CATEGORY' => 'Show articles of the following category only',
  'INTEGRATION_TEXT_SHOW_ARTICLE_SEARCH' => 'Use search for articles',
  'INTEGRATION_TEXT_START' => 'To integrate FanPress CM into your website, following these instructions.',
  ...
  'LABEL_FIELD_FIELDS' => 'Perform search in...',
  ...
  'LABEL_FIELD_INTEGRATION' => 'Integration Assistant',
  ...
  'NOTIFICATION_EXPERIMENTAL_MINJS' => 'Not-minified JavaScript files in used. Do not forget to minify the files before deployment.',
  ...
  'PACKAGES_FAILED_ERROR905' => 'The local package signature is incorrect. Check for a failed download or an outdated local update info storage. Check for new updates and run the update again afterward.<br>%s',
  ...
  'REMINDER_DELETE_FAILED' => 'The resubmission could not be deleted!',
  'REMINDER_DELETE_SUCCESS' => 'The resubmission has been deleted.',
  'REMINDER_SAVE_FAILED' => 'The resubmission could not been saved!',
  ...
  'SYSTEM_OPTIONS_COMMENT_DEFAULT_ACTIVE' => 'Enabled by default for new articles',
  'SYSTEM_OPTIONS_COMMENT_ENABLED_GLOBAL' => 'Comment system is active',
  'SYSTEM_OPTIONS_COMMENT_MARKSPAM_PASTCHECK' => 'Automatic spam flagging when X comments have already spam flag',
  ...
  'SYSTEM_OPTIONS_COMMENT_PRIVACYOPTIN' => 'Privacy policy consent required',
  ...
  'SYSTEM_OPTIONS_FILEMANAGER_LIMIT' => 'Number of files per page',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEW' => 'File manager view',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWCARDS' => 'Cards',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWLIST' => 'List (details)',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWSMALL' => 'List (small)',
  ...
  'SYSTEM_OPTIONS_STYLESHEET' => 'Path to your CSS file for preview',
  ...
  'SYSTEM_STATS_ARTICLES_ALL' => 'Total articles (thereof active)',
  ...
  'SYSTEM_STATS_CACHE_REMINDERS' => 'Reminders',
  ...
  'SYSTEM_STATS_IP_LOCKS' => 'Locked IP addresses',
  ...
  'UPDATE_MODULECHECK_FAILED' => 'No update check could be performed!',
  'UPDATE_MODULECHECK_NEW' => 'Updates are available for some modules.',
  'UPDATE_NOTAUTOCHECK' => 'No automatic update check could be performed!',
  'UPDATE_VERSIONCECK_FILEDB_ERR' => 'The version in the file system and the database do not match.',
  ...
  'UPDATE_VERSIONCHECK_NEW' => 'FanPress CM version <i>{{version}}</i> is available!',
  ...
  'USERS_META_RESET_DASHBOARD' => '',
  'USERS_META_RESET_DASHBOARD_DISABLED' => 'Reset inactive',
  'USERS_META_RESET_DASHBOARD_POS' => 'Reset positions',
