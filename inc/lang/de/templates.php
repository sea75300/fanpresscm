...
$lang = array(
    ...
    'TEMPLATE_NOTES' => '<strong>Hinweis:</strong><br>' .
    '- In Templates darf die Gestaltung nur über <strong>CSS-Klassen/IDs oder Inline-"style"-Angaben</strong> erfolgen. HTML-Tags wie <em>body, style, etc.</em> machen den Code invalide und können Probleme verursachen!<br>' .
    ...
    'TEMPLATE_ARTICLE_PERMALINK' => 'Artikel-Link',
    'TEMPLATE_ARTICLE_SHORTLINK' => 'Kurzlink',
    'TEMPLATE_ARTICLE_TEXT' => 'Artikel-Text',
