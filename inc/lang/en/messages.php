...
$lang = array(
    ...
    'TEMPLATE_NOT_WRITABLE' => 'The selected template is not writable. Please check file permissions within the server.',
    ...
    'SAVE_SUCCESS_TEMPLATE' => 'Success saving template {{filename}}!',
    ...
    'SAVE_SUCCESS_ARTICLERESTORE' => 'The selected elements are restored!',
    ...
    'SAVE_FAILED_TEMPLATE' => 'An error occurred while saving template {{filename}}!',
    'SAVE_FAILED_TEMPLATE_CF_URLMISSING' => 'Unable to save comment form template, because {{submitUrl}} replacement is missing!',
    'SAVE_FAILED_TEMPLATE_CF_PRIVACYMISSING' => 'Unable to save comment form template, because {{privacyComfirmation}} replacement is missing!',
    ...
    'SAVE_FAILED_ARTICLERESTORE' => 'Unable to restore the selected elements!',
    ...
    'PACKAGES_FAILED_DOWNLOAD_UNTRUSTED' => 'The available package file will nt be downloaded due to untrusted packeg source <em>{{var}}</em>.',
    'PACKAGES_FAILED_ERROR901' => 'Unable to connect to the package server!',
    'PACKAGES_FAILED_ERROR902' => 'Unable to create local package file!',
    'PACKAGES_FAILED_ERROR903' => 'Unable to write local package file copy!',
    'PACKAGES_FAILED_ERROR904' => 'Local package file copy was not found!',
    'PACKAGES_FAILED_ERROR906' => 'Unable to open package file archive!',
    ...
    'PACKAGEMANAGER_FAILED' => 'An error occurred during installation of the package. See error log for further information.',
    ...
    'MODULES_FAILED_DEPENCIES' => 'Unfulfilled dependencies for detected, this module cannot be installed!',
