...
$lang = array (
  ...
  'ARTICLE_SEARCH_CATEGORY' => 'Kategorie',
  'ARTICLE_SEARCH_CHGUSER' => 'Zuletzt geändert von Benutzer',
  'ARTICLE_SEARCH_COMMENTS' => 'Kommentare aktiv',
  'ARTICLE_SEARCH_DATE_FROM' => 'Geschrieben am von',
  'ARTICLE_SEARCH_DATE_FROM_CHG' => 'Zuletzt geändert von',
  'ARTICLE_SEARCH_DATE_TO' => 'Geschrieben am bis',
  'ARTICLE_SEARCH_DATE_TO_CHG' => 'Zuletzt geändert bis',
  'ARTICLE_SEARCH_DRAFT' => 'Entwurf',
  'ARTICLE_SEARCH_LOGIC' => 'Verknüpfung',
  'ARTICLE_SEARCH_LOGICAND' => 'UND',
  'ARTICLE_SEARCH_LOGICNONE' => 'keine',
  'ARTICLE_SEARCH_LOGICOR' => 'ODER',
  'ARTICLE_SEARCH_PINNED' => 'Gepinnt',
  'ARTICLE_SEARCH_POSTPONED' => 'Geplant',
  'ARTICLE_SEARCH_START' => 'Suche starten...',
  'ARTICLE_SEARCH_TEXT' => 'Nach diesem Text suchen',
  'ARTICLE_SEARCH_TYPE_TEXT' => 'Text',
  'ARTICLE_SEARCH_TYPE_TITLE' => 'Titel',
  'ARTICLE_SEARCH_USER' => 'Autor',
  'BACKUPS_NOTICE_POSTGRES' => 'Die automatische Sicherung der Datenbank wird Postgres aktuell nicht unterstützt.',
  'CACHE_CLEARED_FAILED' => 'Der Cache konnte nicht geleert!',
  ...
  'COMMMENT_MOVE' => 'Kommentar gehört zu Artikel',
  ...
  'EDITOR_HTML_BUTTONS_REDO' => 'Wiederholen',
  ...
  'EDITOR_HTML_BUTTONS_UNDO' => 'Rückgängig',
  ...
  'FILE_FORM_UPLOADPAUSE' => 'Upload anhalten',
  'FILE_FORM_UPLOADRESUME' => 'Upload fortsetzen',
  ...
  'FILE_LIST_EDIT_DYNAMIC' => 'Auswahl und Bild (nicht) gemeinsam verschieben',
  'FILE_LIST_EDIT_FLIP' => 'Spiegeln',
  ...
  'FILE_LIST_INSERT_FAILED_IMAGE' => 'Die gewählte Datei kann nicht als Bild eingefügt werden.',
  'FILE_LIST_INSERT_FAILED_VIDEO' => 'Die gewählte Datei kann nicht als Video eingefügt werden.',
  ...
  'FILE_LIST_OPEN_FULL' => 'Datei öffnen',
  ...
  'GLOBAL_CREDENTIALS' => 'Zugangsdaten',
  ...
  'GLOBAL_SORT_BY' => 'Sortieren nach',
  'GLOBAL_SORT_ODER' => 'Sortierung ist',
  ...
  'HL_PACKAGEMGR_SYSUPDATES' => 'Systemupdate installieren',
  'HL_PROFILE' => 'Profil',
  'HL_REMINDER' => 'Erinnerung',
  ...
  'INTEGRATION_INCLUDE_API' => 'API-Klasse einbinden',
  'INTEGRATION_INCLUDE_CSS' => 'CSS-Klassen für Gestaltung',
  'INTEGRATION_LATEST_NEWS' => 'Anzeige der Latest News',
  'INTEGRATION_PAGE_NUMBERS_TITLE' => 'Seitenzahlen in Seitentitel anzeigen',
  'INTEGRATION_RSS_FEED' => 'RSS-Feed einbinden',
  'INTEGRATION_SHOW_ARTICLES' => 'Artikel ausgeben',
  'INTEGRATION_SHOW_ARTICLE_TITLE' => 'Artikelüberschrift in Seitentitel anzeigen',
  'INTEGRATION_TEXT_API' => 'Füge den folgenden Code-Abschnitt die folgende Datei ein: %s',
  'INTEGRATION_TEXT_API_MAINFILE' => 'Trage hier den Pfad der Datei ein, über welchen der Einstieg in deine Seiet erfolgt.',
  'INTEGRATION_TEXT_ARTICLE_TITLE' => 'Füge den folgenden Code-Abschnitt im "title"-Tag deiner Webseite sein.',
  'INTEGRATION_TEXT_CSS' => 'Füge die folgenden CSS-Klassen in die CSS-Datei ein, welche von deiner Webseite verwendet wird.',
  'INTEGRATION_TEXT_LATEST_NEWS' => 'Füge den folgenden Code-Abschnitt an der Stelle ein, an der die "Latest News" auf deiner Webseite angezeigt werden sollen.',
  'INTEGRATION_TEXT_PAGE_TITLE' => 'Füge den folgenden Code-Abschnitt im "title"-Tag deiner Webseite sein',
  'INTEGRATION_TEXT_RSS_FEED' => 'Füge den folgenden Code-Abschnitt im "head"-Bereich deiner Webseite sein.',
  'INTEGRATION_TEXT_SHOW_ARTICLE' => 'Füge den folgenden Code-Abschnitt an der Stelle ein, an der die Artikel bzw. generell der Inhalt auf deiner Webseite angezeigt wird.',
  'INTEGRATION_TEXT_SHOW_ARTICLE_CATEGORY' => 'Zeige nur Artikel der folgenden Kategorie',
  'INTEGRATION_TEXT_SHOW_ARTICLE_SEARCH' => 'Suche nach Artikeln nutzen',
  'INTEGRATION_TEXT_START' => 'Zur Integration von FanPress CM in deine Webseite folge den folgenden Anleitungen.',
  ...
  'LABEL_FIELD_FIELDS' => 'Suche in Feld...',
  ...
  'LABEL_FIELD_INTEGRATION' => 'Integrationsassistent',
  ...
  'MODULES_SEARCH_FILTER_STATUS' => 'Status',
  ...
  'NOTIFICATION_EXPERIMENTAL_MINJS' => 'Ungepackte JavaScript-Dateien werden verwendet. Vergesse nicht die Dateien vor Release zu packen.',
  ...
  'PACKAGES_FAILED_ERROR905' => 'Die Prüfsumme der lokalen Paketdatei ist falsch. Dies kann u. a. durch einen fehlerhaften Download oder veraltete Daten im lokalen Updatespeicher entstehen. Prüfe auf neue Updates und versuche es im Anschluss erneut.<br>%s',
  ...
  'REMINDER_DELETE_FAILED' => 'Die Wiedervorlage konnte nicht gelöscht werden!',
  'REMINDER_DELETE_SUCCESS' => 'Die Wiedervorlage wurde gelöscht.',
  'REMINDER_SAVE_FAILED' => 'Die Wiedervorlage konnte nicht gespeichert werden!',
  ...
  'SYSTEM_HL_OPTIONS_EDITOR' => 'Editor',
  ...
  'SYSTEM_OPTIONS_COMMENT_DEFAULT_ACTIVE' => 'Standardmäßig für neue Artikel aktivieren',
  'SYSTEM_OPTIONS_COMMENT_ENABLED_GLOBAL' => 'Kommentar-System ist aktiv',
  'SYSTEM_OPTIONS_COMMENT_MARKSPAM_PASTCHECK' => 'Automatische Spam-Markierung wenn X Kommentare bereits als Spam markiert sind',
  ...
  'SYSTEM_OPTIONS_COMMENT_PRIVACYOPTIN' => 'Datenschutz-Zustimmung erforderlich',
  ...
  'SYSTEM_OPTIONS_FILEMANAGER_LIMIT' => 'Anzahl Dateien pro Seite',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEW' => 'Dateimanager-Ansicht',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWCARDS' => 'Karten',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWLIST' => 'Liste (Details)',
  'SYSTEM_OPTIONS_FILEMANAGER_VIEWSMALL' => 'Liste (klein)',
  ...
  'SYSTEM_OPTIONS_STYLESHEET' => 'Pfad zu deiner CSS-Datei für Vorschau',
  ...
  'SYSTEM_STATS_ARTICLES_ALL' => 'Artikel gesamt (davon aktiv)',
  ...
  'SYSTEM_STATS_CACHE_REMINDERS' => 'Erinnerungen',
  ...
  'SYSTEM_STATS_IP_LOCKS' => 'Gesperrte IP-Adressen',
  ...
  'UPDATE_MODULECHECK_FAILED' => 'Es konnte keine Update-Prüfung durchgeführt werden!',
  'UPDATE_MODULECHECK_NEW' => 'Für einige Module sind Updates verfügbar.',
  'UPDATE_NOTAUTOCHECK' => 'Es konnte keine automatische Update-Prüfung durchgeführt werden!',
  'UPDATE_VERSIONCECK_FILEDB_ERR' => 'Die Version im Dateisystem und der Datenbank stimmen nicht überein.',
  ...
  'UPDATE_VERSIONCHECK_NEW' => 'FanPress CM Version <i>{{version}}</i> ist verfügbar!',
  ...
  'USERS_META_RESET_DASHBOARD_DISABLED' => 'Deaktivierte zurücksetzen',
  'USERS_META_RESET_DASHBOARD_POS' => 'Positionen zurücksetzen',
