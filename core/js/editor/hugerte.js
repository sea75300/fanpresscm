/**
 * FanPress CM HugeRTE Wrapepr Editor Namespace
...
if (fpcm.editor) {
    ...
    fpcm.editor.initEditor = function () {
        ...
        fpcm.vars.jsvars.editorConfig.file_picker = function (callback, value, meta) {
            ...
            hugerte.activeEditor.windowManager.openUrl({
                ...
                id: 'fpcm-dialog-editor-hugerte-filemanager',
                buttons: _btns,
        ...
        fpcm.editor_hugerte.create(fpcm.vars.jsvars.editorConfig);
    ...
    fpcm.editor.insertGalleryByEditor = function (_values) {
        ...
        top.hugerte.activeEditor.insertContent(fpcm.editor.getGalleryReplacement(_values) + fpcm.vars.jsvars.editorGalleryTagEnd);
        top.hugerte.activeEditor.windowManager.close();
        top.hugerte.activeEditor.windowManager.close();
    ...
    fpcm.editor.insertGalleryDisabled = function (_mode) {
        ...
        if (top.hugerte === undefined) {
            return true;
        }

        if (top.hugerte.activeEditor === undefined) {
            return true;
        }

        let _cont = top.hugerte.activeEditor.getContent();
