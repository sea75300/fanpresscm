...
<div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
    <div class="col">
        <div class="list-group my-3">
            <div class="list-group-item bg-secondary bg-gradient text-white" aria-label="<?php $theView->write('PERMISSION_ARTICLES'); ?>"><?php $theView->icon('book'); ?> <?php $theView->write('PERMISSION_ARTICLES'); ?></div>
    ...
    <div class="col">
        <div class="list-group my-3">
            <div class="list-group-item bg-secondary bg-gradient text-white" aria-label="<?php $theView->write('PERMISSION_COMMENTS'); ?>"><?php $theView->icon('comments'); ?> <?php $theView->write('PERMISSION_COMMENTS'); ?></div>
    ...
    <div class="col">
        <div class="list-group my-3">
            <div class="list-group-item bg-secondary bg-gradient text-white" aria-label="<?php $theView->write('PERMISSION_UPLOADS'); ?>"><?php $theView->icon('folder-open'); ?> <?php $theView->write('PERMISSION_UPLOADS'); ?></div>
    ...
    <div class="col">
        <div class="list-group my-3">
            <div class="list-group-item bg-secondary bg-gradient text-white" aria-label="<?php $theView->write('PERMISSION_SYSTEM'); ?>"><?php $theView->icon('cog'); ?> <?php $theView->write('PERMISSION_SYSTEM'); ?></div>
    ...
    <div class="col">
        <div class="list-group my-3">
            <div class="list-group-item bg-secondary bg-gradient text-white" aria-label="<?php $theView->write('PERMISSION_MODULES'); ?>"><?php $theView->icon('plug'); ?> <?php $theView->write('PERMISSION_MODULES'); ?></div>
