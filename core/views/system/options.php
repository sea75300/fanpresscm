            ...
            <div id="tabs-options-general">
                <table class="fpcm-ui-table fpcm-ui-options">
                    ...
                    <tr>			
                        ...
                        <td><?php fpcm\model\view\helper::select('system_cache_timeout', $theView->lang->translate('SYSTEM_OPTIONS_CACHETIMEOUT_INTERVAL'), $globalConfig['system_cache_timeout'], false, false); ?></td>
                    </tr>                               
                    <tr>			
            ...
            <div id="tabs-options-editor">
                <table class="fpcm-ui-table fpcm-ui-options">
                    ...
                    <tr>			
                        ...
                        <td><?php fpcm\model\view\helper::select('articles_revisions_limit', $theView->lang->translate('SYSTEM_OPTIONS_NEWS_REVISIONS_LIMIT_LIST'), $globalConfig['articles_revisions_limit'], false, false); ?></td>
                    </tr>
                    <tr>			
            ...
            <div id="tabs-options-comments">
                <table class="fpcm-ui-table fpcm-ui-options">
                   ...
                   <tr>			
                        ...
                        <td><?php fpcm\model\view\helper::select('comments_flood', $theView->lang->translate('SYSTEM_OPTIONS_FLOODPROTECTION_INTERVALS'), $globalConfig['comments_flood'], false, false); ?></td>
                   </tr>		
                   <tr>			
            ...
            <div id="tabs-options-security">
                <table class="fpcm-ui-table fpcm-ui-options">
                    ...
                    <tr>			
                        ...
                        <td><?php fpcm\model\view\helper::select('system_session_length', $theView->lang->translate('SYSTEM_OPTIONS_SESSIONLENGHT_INTERVALS'), $globalConfig['system_session_length'], false, false); ?></td>
                    </tr>			 			 
                    <tr>			
            ...
            <div id="tabs-options-extended">
                <table class="fpcm-ui-table fpcm-ui-options">
                    ...
                    <tr>			
                         ...
                         <td><?php fpcm\model\view\helper::select('system_updates_manual', $theView->lang->translate('SYSTEM_OPTIONS_UPDATESMANUAL'), $globalConfig['system_updates_manual'], false, false); ?></td>
                    </tr>
                    <?php if ($smtpActive) : ?>
