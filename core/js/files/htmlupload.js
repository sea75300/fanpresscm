        ...
        fpcm.dom.fromId('btnAddFile').click(function () {
            ...
            fpcm.dom.fromClass('fpcm-ui-fileinput-select').change(function () {
                ...
                for (var i=0;i<fileList.length;i++) {
                    fpcm.ui.appendHtml('#fpcm-ui-phpupload-filelist', '<div class="row g-0 fpcm-ui-padding-md-tb"><div class="col-12 fpcm-ui-margin-md-top fpcm-ui-margin-md-bottom">' + fpcm.ui.getIcon('file-image', { prefix: 'far', size: 'lg' }) + fileList[i].name +'</div></div>')
                }
