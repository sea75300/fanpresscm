...
class itemlist extends \fpcm\controller\abstracts\controller {
    ...
    protected function getDataViewCols()
    {
        return [
            ...
            (new \fpcm\components\dataView\column('replacement', 'WORDBAN_ICON_PATH'))->setSize(4),
    ...
    protected function initDataViewRow($item)
    {
        $metaData = [
            ...
            (new \fpcm\view\helper\icon('thumbs-o-up fa-inverse'))->setClass('fpcm-ui-editor-metainfo fpcm-ui-status-' . $item->getLockArticle())->setText('WORDBAN_APPROVE_ARTICLE')->setStack('square'),
