...
class pubTemplateTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testParseArticleTemplate()
    {
        ...
        $this->assertContains('Lorem ipsum dolor sit amet, consetetur sadipscing elitr!', $output);
        $this->assertContains($co->system_url, $output);
        $this->assertContains($uo->getDisplayname(), $output);
        $this->assertContains((string) new fpcm\view\helper\dateText($ts), $output);
    ...
    public function testParseCommentTemplate()
    {
        ...
        $this->assertContains('Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis. ', $output);
        $this->assertContains($co->system_url, $output);
        $this->assertContains($uo->getDisplayname(), $output);
        $this->assertContains((string) new fpcm\view\helper\dateText($ts), $output);
