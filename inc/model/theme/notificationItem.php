...
class notificationItem {
    ...
    public function __toString() : string
    {
        ...
        if ($this->callback && strpos($this->callback, 'http') === 0) {
            return "<li title=\"{$this->description}\" id=\"{$this->id}\" class=\"fpcm-menu-top-level1 fpcm-ui-float-right fpcm-notification-item\"><a href=\"{$this->callback}\">" . $this->icon . "</a></li>";
        }

        if ($this->callback) {
            return "<li title=\"{$this->description}\" id=\"{$this->id}\" data-callback=\"{$this->callback}\" class=\"fpcm-menu-top-level1 fpcm-ui-float-right fpcm-notification-item\"><a href=\"#\">" . $this->icon . "</a></li>";
        }

        return "<li title=\"{$this->description}\" id=\"{$this->id}\" class=\"fpcm-menu-top-level1 fpcm-ui-float-right fpcm-notification-item\">" . $this->icon . "</li>";
    }
