<?php
     ...
     * @since FPCM 3.4
     */
    final class articlesByCondition extends \fpcm\model\abstracts\event {

        /**
         * wird ausgeführt, wenn Artikel-Suche ausgeführt wird
         * @param array $data
         * @return array
         */
        public function run($data = null) {
            ...
            foreach ($eventClasses as $eventClass) {
                ...
                $eventClass = \fpcm\model\abstracts\module::getModuleEventNamespace($classkey, 'articlesByCondition');
