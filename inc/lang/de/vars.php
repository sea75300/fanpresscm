...
$lang = array (
  ...
  'CRONJOB_DBBACKUPS_TEXT' => 'Um {{filetime}} wurde durch den Cronjob eine Sicherung der FanPress CM Datenbank-Tabellen erzeugt. Die Datei findest du unter {{dumpfile}} und ggf. als Anhang an dieser E-Mail.',
...
{{acplink}}',
  ...
  'GLOBAL_PLEASE_SELECT' => 'Bitte wählen',
  ...
  'GLOBAL_YES' => 'Ja',
  'GUI_VIEWPORT_SIZE' => 'Achtung! Auch wenn viel Wert auf eine gute mobile Nutzung gelegt wurde, kann es unter der aktuellen Auflösung zu Einschränkungen bei der Benutzbarkeit der Software kommen.',
  ...
  'INSTALLER_FINALIZE_DIABLED' => '<strong>Wichtig:</strong> Lösche via FTP unbedingt die Datei <strong>/data/config/installer.enabled</strong> um den Installationsassistent zu deaktivieren, sollte die Datei noch existieren!!!!',
