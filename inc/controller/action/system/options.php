...
class options extends \fpcm\controller\abstracts\controller {
    ...
    public function process()
    {
        ...
        $this->view->addButtons([
            ...
            (new \fpcm\view\helper\button('syschecksubmitstats', 'syschecksubmitstats'))->setText('SYSTEM_OPTIONS_SYSCHECK_SUBMITSTATS')->setClass('fpcm-ui-maintoolbarbuttons-tab2 fpcm-ui-hidden')->setIcon('line-chart'),
        ]);
