<div class="fpcm-content-wrapper">
    <h1>
        <span class="fa fa-history"></span> <?php $theView->lang->write('HL_CRONJOBS'); ?>
    </h1>
            ...
            <div id="tabs-options-general">
                ...
                <table class="fpcm-ui-table fpcm-ui-logs fpcm-ui-logs-cronjobs">
                    ...
                    <tr <?php if ($currentTime > ($cronjob->getNextExecTime() - 60)) : ?>class="fpcm-ui-important-text"<?php endif; ?>>
                        ...
                        <td class="fpcm-cronjob-interval fpcm-ui-center"><?php fpcm\model\view\helper::select('intervals_'.$cronjob->getCronName(), $theView->lang->translate('SYSTEM_OPTIONS_CRONINTERVALS'), $cronjob->getIntervalTime(), false, false, false, 'fpcm-cronjoblist-intervals'); ?></td>
