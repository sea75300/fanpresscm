...
<div class="border-top border-5 border-primary">
    <div id="fileupload" class="fileupload-processing">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-9 col-md-6 mt-3">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-auto flex-grow-1 align-self-center">
        ...
        <div  class="row justify-content-center my-2" role="presentation">
            <div class="col-12 col-md-9 col-md-6 files"></div>
        </div>
    </div>
</div>