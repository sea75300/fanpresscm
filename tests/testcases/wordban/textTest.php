...
class textTest extends testBase {
    ...
    public function testReplacement()
    {
        ...
        $this->assertStringContainsString($GLOBALS['text_replace'], $GLOBALS['articleObj']->getTitle());
        $this->assertStringContainsString($GLOBALS['text_replace'], $GLOBALS['articleObj']->getContent());
