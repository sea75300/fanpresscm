...
{{acplink}}',
  ...
  'EDITOR_HTML_BUTTONS_READMORE' => '<readmore>-Block einfügen (veraltet)',
  ...
  'EDITOR_LASTEDIT' => '<strong class="fpcm-ui-metabox">Zuletzt geändert:</strong>  {{username}} am {{time}}',
  ...
  'IMPORT_MSG_NOFIELDS' => 'Keine Feldzuweisung getroffen. Wähle die zu füllenden Felder aus und sortiete diese gemäß der Reihenfolge in der CSV-Datei',
  ...
  'IMPORT_NOTICE_UTF8' => 'Wichtig! Die zu importierenden Daten müssen im UTF-8-Zeichensatz vorliegen, andersfalls kann es zu defekten Umlauten und sonstigen Sonderzeichen kommen!',
  'IMPORT_PROGRESS' => 'Importiere {{filename}}',
  'IMPORT_RESULT' => 'Import-Zusammenfassung',
  ...
  'INSTALLER_FINALIZE_DIABLED' => '<strong>Wichtig:</strong> Lösche via FTP unbedingt die Datei <strong>/data/config/installer.enabled</strong> um den Installations-Assistent zu deaktivieren, sollte die Datei noch existieren!!!!',
  ...
  'IPLIST_DESCRIPTION' => 'Um eine einzelne IP-Adresse zu sperren, trage sie komplett in das folgende Feld ein. (z. B. 192.168.1.2)<br>Um einen Bereich zu sperren (z. B. 192.168.2.X), ersetzte die letzte(n) Zahl(en) durch einen *. (z. B. 192.168.2.* oder 192.168.*.*)',
  ...
  'PASSWORD_RESET_TEXT' => 'Für dich wurde ein neues Passwort angefordert. Dies lautet <b>{{newpass}}</b>. Hast du dies nicht selbst veranlasst, so kontaktiere am Besten einen Administrator.',
...
Logge dich ein um den Kommentar zu moderieren. {{systemurl}}',
  ...
  'TEMPLATE_SHAREBUTTONS_LIKEBUTTON' => 'Button um Beitrag "Gefällt mir" zu vergeben, öffnet keinen externen Dienst. <b>Achtung!</b> Der Button funktioniert nicht, wenn die Option "Geteilte Artikel über Share-Buttons zählen" deaktiviert ist!',
  ...
  'WELCOME_CONTENT' => 'Du befindest dich im Dashboard von FanPress CM, dem News-System speziell für Fanseiten.<br>Über die Navigation links kannst du in die verschiedenen Bereiche gelangen.<br><br>Nachfolgend findet du einige Statistiken und weitere Informationen zum aktuellen System.',
