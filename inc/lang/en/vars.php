...
Log in to moderate the comment. {{systemurl}}',
  ...
  'SYSTEM_OPTIONS_NEWS_EDITOR_IMGTOOLS' => 'Save image changes in TinyMCE to server',
  ...
  'USERS_AUTHTOKEN_SAVE' => 'To activate two-factor authentication, scan the following QR code with an authenticator app (e.g. Google Authenticator) on your smartphone. Then enter the first 6-digit-code and select "Save".',
  'USERS_AUTHTOKEN_SAVE2' => 'Numerical code for activation',
  'USERS_AVATAR' => 'Avatar',
  ...
  'USERS_ROLL_ADD' => 'Create user role',
