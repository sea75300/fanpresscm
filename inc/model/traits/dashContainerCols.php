...
trait dashContainerCols {
    ...
    {
        trigger_error(sprintf('%s: %s is deprecated as of FPCM 5.3.0, use \fpcm\model\dashboard\types\dataview container instead', self::class, __METHOD__), E_USER_DEPRECATED);
