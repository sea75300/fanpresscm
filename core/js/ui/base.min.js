...
!0:!1},getUniqueID:function(a){return(new Date).getMilliseconds()+Math.random().toString(36).substr(2,9)+(a?a:"")},setFocus:function(a){console.warn("fpcm.ui.setFocus is deprecated and will be removed shortly. Use fpcm.dom.setFocus instead!");fpcm.dom.setFocus(a)},assignHtml:function(a,b){console.warn("fpcm.ui.assignHtml is deprecated and will be removed shortly. Use fpcm.dom.assignHtml instead!");fpcm.dom.assignHtml(a,b)},assignText:function(a,b){console.warn("fpcm.ui.assignText is deprecated and will be removed shortly. Use fpcm.dom.assignText instead!");
fpcm.dom.assignText(a,b)},appendHtml:function(a,b){console.warn("fpcm.ui.appendHtml is deprecated and will be removed shortly. Use fpcm.dom.appendHtml instead!");fpcm.dom.appendHtml(a,b)},prependHtml:function(a,b){console.warn("fpcm.ui.prependHtml is deprecated and will be removed shortly. Use fpcm.dom.prependHtml instead!");fpcm.dom.prependHtml(a,b)},isReadonly:function(a,b){console.warn("fpcm.ui.isReadonly is deprecated and will be removed shortly. Use fpcm.dom.isReadonly instead!");fpcm.dom.isReadonly(a,
b)}};