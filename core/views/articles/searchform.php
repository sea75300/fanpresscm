<div class="fpcm-ui-dialog-layer fpcm-ui-hidden" id="fpcm-dialog-articles-search">
    <table class="fpcm-ui-table fpcm-ui-articles-search">
        <tr>
            <td colspan="2"><?php \fpcm\view\helper::textInput('text', 'fpcm-articles-search-input', '', false, 255, $theView->lang->translate('ARTICLE_SEARCH_TEXT'), 'fpcm-full-width'); ?></td>
        ...
        <tr>    
            <td><?php \fpcm\view\helper::textInput('datefrom', 'fpcm-articles-search-input fpcm-full-width-date', '', false, 10, $theView->lang->translate('ARTICLE_SEARCH_DATE_FROM'), 'fpcm-full-width'); ?></td>
            <td><?php \fpcm\view\helper::textInput('dateto', 'fpcm-articles-search-input fpcm-full-width-date', '', false, 10, $theView->lang->translate('ARTICLE_SEARCH_DATE_TO'), 'fpcm-full-width'); ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
