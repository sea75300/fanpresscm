...
<div class="row justify-content-end mb-3">
    <div class="col-12 col-md-auto fw-bold fs-3 text-start flex-grow-1 align-self-center text-truncate">
        <div class="d-inline-block"><?php print $theView->escape($moduleName); ?></div>
    </div>
...
<div class="row mb-2">
    ...
    <div class="col-12 col-lg-8 text-truncate"><?php print $theView->escape($moduleVersion); ?></div>
</div>
...
<div class="row mb-2">
    ...
    <div class="col-12 col-lg-8 text-truncate"><?php print $theView->escape($moduleAuthor); ?></div>
</div>
...
<div class="row mb-2">
    ...
    <div class="col-12 col-lg-8 text-truncate"><?php print $theView->escape($moduleLink); ?></div>
</div>
...
<div class="row mb-2">
    ...
    <div class="col-12 col-lg-8 text-truncate"><?php print $theView->escape($moduleSysVer); ?></div>
</div>
...
<div class="row mb-2">
    ...
    <div class="col-12 col-lg-8 text-truncate"><?php print $theView->escape($modulePhpVer); ?></div>
</div>
