...
<div class="row g-0 gap-2">
    <div class="col">
        <div class="card m-2 fpcm ui-background-white-50p">
            <div class="card-body">
                <h5 class="card-title"><?php $theView->write('SYSTEM_HL_OPTIONS_SECURITY'); ?></h5>
                <div class="row my-2 row-cols-1 row-cols-lg-2">
                    <div class="col">
    ...
    <div class="col">
        <div class="card m-2 fpcm ui-background-white-50p">
            <div class="card-body">
                <h5 class="card-title"><?php $theView->write('SYSTEM_OPTIONS_EXTENDED_UPDATES'); ?></h5>
                <div class="row my-2">
                    <div class="col">
