...
$lang = array (
  ...
  'BACKUPS_NOTICE_POSTGRES' => 'Die automatsiche Sicherung der Datenbank wird Postgres aktuell nicht unterstützt.',
  'BACKUPS_TAB_DATABASE' => 'Datenbank',
  'BACKUPS_TOP_DESCRIPTION' => 'Die erzeugten Backups kannst du via FTP/ SSH etc. aus dem Verzeichnis {{path}} herunterladen.',
  ...
  'COMMMENT_LASTCHANGE' => 'Zuletzt geändert: {{username}} am {{time}}',
  ...
  'CRONJOB_CLEARLOGS' => 'System-Protokollee leeren',
  ...
  'CRONJOB_ECEDUTING' => 'Cronjob {{cjname}} wird ausgeführt, bitte warten...',
...
{{acplink}}',
  ...
  'DASHBOARD_USERLIST' => 'Team-Kontakte',
  ...
  'DELETE_FAILED_FILES' => 'Die Dateien konnten nicht gelöscht werden!{{filenames}}',
  'DELETE_FAILED_IPADDRESS' => 'Die IP-Adresse konnten nicht gelöscht werden!',
  'DELETE_FAILED_RENAME' => 'Die Datei {{filename1}} konnte nicht in {{filename2}} umbenannt werden!',
  ...
  'DELETE_SUCCESS_FILES' => 'Die Dateien wurden gelöscht!{{filenames}}',
  ...
  'EDITOR_AUTHOREDIT' => 'Geschrieben von: {{username}} am {{time}}',
  ...
  'EDITOR_HTML_BUTTONS_QUOTE_TEXT' => 'Zitattext',
  'EDITOR_HTML_BUTTONS_READMORE' => '-Block einfügen (veraltet)',
  ...
  'EDITOR_LASTEDIT' => 'Zuletzt geändert:  {{username}} am {{time}}',
  ...
  'INSTALLER_CREATETABLES_STEP' => 'erzeuge Tabelle {{tablename}}...',
  ...
  'INSTALLER_FINALIZE_DIABLED' => 'Wichtig: Lösche via FTP unbedingt die Datei /data/config/installer.enabled um den Installations-Assistent zu deaktivieren, sollte die Datei noch existieren!!!!',
  'INSTALLER_FINALIZE_TEXT' => 'Herzlichen Glückwunsch! Die Installation von FanPress CM wurde erfolgreich abgeschlossen! Du kannst dich nun in deinem System anmelden!',
  ...
  'IPLIST_DESCRIPTION' => 'Um eine einzelne IP-Adresse zu sperren, trage sie komplett in das folgende Feld ein. (z. B. 192.168.1.2)Um einen Bereich zu sperren (z. B. 192.168.2.X), ersetzte die letzte(n) Zahl(en) durch einen *. (z. B. 192.168.2.* oder 192.168.*.*)',
  ...
  'PACKAGEMANAGER_CHECKPKG' => 'Überprüfe Paketinformationen {{var}}',
  ...
  'PACKAGEMANAGER_DOWNLOAD' => 'Herunterladen des Pakets {{var}} {{var2}}',
  'PACKAGEMANAGER_EXTRACT' => 'Entpacke Paket {{var}}',
  ...
  'PACKAGEMANAGER_FAILED_UPDATE' => 'Bei der Aktualisierung des Pakets ist ein Fehler aufgetreten. Ausführliche Informationen beinhaltet des Fehler-Log.',
  ...
  'PACKAGES_FAILED_DOWNLOAD_UNTRUSTED' => 'Die verfügbare Paketdatei wird nicht heruntergeladen, da dem Paket-Server {{var}} nicht vertraut wird.',
  ...
  'PASSWORD_NEWPASSWORDSET_TEXT' => 'Für deinen FanPress CM-Account {{username}} wurde das Passwort {{newpass}} festgelegt. Mit diesen Daten kannst du dich anmelden und auch ein eigenes Passwort vergeben.',
  'PASSWORD_RESET_SUBJECT' => 'Neues Passwort angefordert',
  'PASSWORD_RESET_TEXT' => 'Für dich wurde ein neues Passwort angefordert. Dies lautet {{newpass}}. Hast du dies nicht selbst veranlasst, so kontaktiere am Besten einen Administrator.',
  ...
  'PROFILE_MENU_LOGGEDINAS' => 'angemeldet als {{username}}',
  ...
  'PUBLIC_ARCHIVE_LIMIT' => 'Das Archiv zeigt nur Artikel an, welche nach dem {{archievDate}} veröffentlicht wurden.',
...
Logge dich ein um den Kommentar zu moderieren. {{systemurl}}',
  ...
  'RECENT_ARTICLES' => 'Zuletzt geschriebene News',
  'RECENT_COMMENTS' => 'Zuletzt geschriebene Kommentare',
  'RECENT_FPCMNEWS' => 'Aktuelle FanPress CM News',
  ...
  'SAVE_FAILED_ARTICLENEWTWEET' => 'Für die Artikel konnten keine Tweets erzeugt werden!{{titles}}',
  ...
  'SAVE_FAILED_OPTIONS_SMTP_HOST' => 'Für die SMTP-Server-Adresse wurde ein fehelrhafter Wert erkannt!',
  ...
  'SAVE_FAILED_PASSWORD_SECURITY_PWNDPASS' => 'Das eingegebene Passwort wird sehr häufig verwendet und ist daher potentiell gefährlich! Es sollte daher nicht verwendet werden.',
  ...
  'SAVE_FAILED_UPLOADPHP' => 'Beim hochladen der Dateien ist ein Fehler aufgetreten!{{filenames}}',
  ...
  'SAVE_SUCCESS_ARTICLENEWTWEET' => 'Für die Artikel wurden neue Tweets erzeugt!{{titles}}',
  ...
  'SAVE_SUCCESS_TEMPLATE' => 'Das Template {{filename}} wurde gespeichert!',
  ...
  'SAVE_SUCCESS_UPLOADPHP' => 'Die Dateien wurden hochgeladen!{{filenames}}',
  ...
  'SUCCESS_FILES_NEWTHUMBS' => 'Neue Thumbnails wurden erzeugt!{{filenames}}',
  ...
  'SYSTEM_UPDATE' => 'Verfügbare Updates',
  ...
  'TEMPLATE_ARTICLE_TEXTSHORT' => 'Kurzversion des Artikel-Text, Vewendung von {{pagebreakVar}} möglich',
  ...
  'TEMPLATE_COMMMENTFORM_SUBMITURL' => 'URL des Kommentar-Formulars (wichtig!)',
  ...
  'TEMPLATE_COMMMENT_MENTIONID' => 'ID um {{mention}}:{{/mention}} zu nutzen',
  ...
  'TEMPLATE_NOTES' => '- In Templates darf die Gestaltung nur über CSS-Klassen/IDs oder Inline-&quot;style&quot;-Angaben erfolgen. HTML-Tags wie body, style, etc. machen den Code invalide und können Probleme verursachen!- Bei Platzhaltern mit einem öffnenden und schließendem Tag in der Form &quot;{{A}}:{{/A}}&quot; kann der Doppelpunkt durch einen eigenen Text ersetzt werden.',
  ...
  'UPDATE_VERSIONCECK_FILETXT_ERR' => 'Die Datei /data/config/files.txt wurde nicht gefunden. Dies sollte nicht passieren und kann zu unvorhergesehenem Verhalten führen.',
  ...
  'UPDATE_VERSIONCHECK_CURRENT' => 'Deine Version von FanPress CM ist aktuell!',
  'UPDATE_VERSIONCHECK_NEW' => 'FanPress CM Version {{version}} ist verfügbar! {{btn}}',
  ...
  'USERS_AUTHTOKEN_SAVE' => 'Zur Aktivierung der Zwei-Faktor-Authentifizierung scanne den folgenden QR Code mit einer App wie &quot;Google Authenticator&quot; auf deinem Smartphone.Trage im Anschluss den ersten Zahlencode ein und wähle &quot;Speichern&quot;',
  ...
  'WELCOME_CONTENT' => 'Du befindest dich im Dashboard von FanPress CM, dem News-System speziell für Fanseiten.<br>Über die Navigation kannst du in die verschiedenen Bereiche gelangen.<br><br><br>Nachfolgend fandest du einige Statistiken und weitere Informationen zum aktuellen System.',
  'WELCOME_HEADLINE' => 'Willkommen {{username}}!',
