<?php
    ...
    class notificationItem {
        ...
        function __construct($description, $icon, $class = false, $id = false, $callback = false) {
            $this->description  = \fpcm\classes\loader::getObject('language')->translate($description);
            $this->icon         = $icon;
        ...
        public function setDescription($description, array $params = []) {
            $this->description = \fpcm\classes\loader::getObject('language')->translate($description, $params);
        }
