<div class="fpcm-content-wrapper">
    <form method="post" action="<?php print $theView->self; ?>?module=system/templates" enctype="multipart/form-data">
        ...
        <div class="fpcm-tabs-general">
            <ul>
                <li><a href="#tabs-templates-articles" class="fpcm-template-tab" data-tpl="1"><?php $theView->lang->write('TEMPLATE_HL_ARTICLES'); ?></a></li>
                <?php if (isset($contentArticleSingle) && isset($replacementsArticleSingle)) : ?>
                <li><a href="#tabs-templates-article" class="fpcm-template-tab" data-tpl="2"><?php $theView->lang->write('TEMPLATE_HL_ARTICLE_SINGLE'); ?></a></li>
                <?php endif; ?>
                <li><a href="#tabs-templates-comments" class="fpcm-template-tab" data-tpl="3"><?php $theView->lang->write('TEMPLATE_HL_COMMENTS'); ?></a></li>
                <li><a href="#tabs-templates-commentform" class="fpcm-template-tab" data-tpl="4"><?php $theView->lang->write('TEMPLATE_HL_COMMENTFORM'); ?></a></li>
                <li><a href="#tabs-templates-latestnews" class="fpcm-template-tab" data-tpl="5"><?php $theView->lang->write('TEMPLATE_HL_LATESTNEWS'); ?></a></li>
                <li><a href="#tabs-templates-tweet" class="fpcm-template-tab" data-tpl="6"><?php $theView->lang->write('TEMPLATE_HL_TWEET'); ?></a></li>
