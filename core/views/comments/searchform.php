<div class="fpcm-ui-dialog-layer fpcm-hidden" id="fpcm-dialog-comments-search">
    <table class="fpcm-ui-table fpcm-ui-comments-search">
        <tr>
            <td colspan="2"><?php \fpcm\view\helper::textInput('text', 'fpcm-comments-search-input', '', false, 255, $theView->lang->translate('ARTICLE_SEARCH_TEXT'), 'fpcm-full-width'); ?></td>
        ...
        <tr>    
            <td><?php \fpcm\view\helper::textInput('datefrom', 'fpcm-comments-search-input fpcm-full-width-date', '', false, 10, $theView->lang->translate('ARTICLE_SEARCH_DATE_FROM'), 'fpcm-full-width'); ?></td>
            <td><?php \fpcm\view\helper::textInput('dateto', 'fpcm-comments-search-input fpcm-full-width-date', '', false, 10, $theView->lang->translate('ARTICLE_SEARCH_DATE_TO'), 'fpcm-full-width'); ?></td>
            <td></td>
        </tr>
        <tr>
            <td><?php \fpcm\view\helper::textInput('articleId', 'fpcm-comments-search-input', '', false, 20, $theView->lang->translate('COMMMENT_SEARCH_ARTICLE'), 'fpcm-full-width'); ?></td>
            <td></td>
