<?php
    ...
    $lang = array(        
        ...
        'SYSTEM_OPTIONS_SYSCHECK_DBDRV_MYSQL'       => 'MySQL/ MariaDB Datenbanktreiber - {{value}}',
        'SYSTEM_OPTIONS_SYSCHECK_DBDRV_PGSQL'       => 'Postgres Datenbanktreiber - {{value}}',
        'SYSTEM_OPTIONS_SYSCHECK_DBDRV_ACTIVE'      => 'Aktiver Datenbanktreiber - {{value}}',
