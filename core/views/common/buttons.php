...
<div class="navbar navbar-dark border-bottom border-1 border-secondary fpcm ui-background-white-50p py-0 <?php if (!empty($toolbarClass)) : print $toolbarClass; endif; ?>" id="fpcm-ui-toolbar" data-fpcm-toolbar="<?php $theView->escape($theView->toolbarArea); ?>">
