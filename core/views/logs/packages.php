...
<?php if (!count($items)) : ?>
<p class="fpcm-ui-padding-none fpcm-ui-margin-none"><?php $theView->icon('file-text-o')->setSize('lg')->setStack('ban fpcm-ui-important-text')->setStackTop(true); ?> <?php $theView->write('GLOBAL_NOTFOUND2'); ?></p>
<?php else : ?>
